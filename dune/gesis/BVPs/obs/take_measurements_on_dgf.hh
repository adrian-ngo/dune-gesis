 ...
 * Bugfix on 19.Nov. 2012
 * + evaluate mesuring point only on one process (interior partition)
 *
...
namespace Dune {
 ...
 // Take care:
 // 1.) 
 // This method contains a check which relies on structured cubical grid element!
...
// Take care:
// This method contains a check which relies on structured cubical grids!
// Points on the lower boundary of the domain will not be detected!
